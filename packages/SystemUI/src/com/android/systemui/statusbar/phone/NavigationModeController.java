...
public class NavigationModeController implements Dumpable {
    ...
    private final class DevilianSettingsObserver extends ContentObserver {
        public DevilianSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private DevilianSettingsObserver mSettingsObserver;
    ...
    public NavigationModeController(Context context,
        ...
        mSettingsObserver = new DevilianSettingsObserver(new Handler());
