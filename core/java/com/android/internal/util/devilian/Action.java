...
package com.android.internal.util.devilian;
    ...
    public static void processActionWithOptions(Context context,
            ...
            if (action.equals(ActionConstants.ACTION_HOME)) {
                ...
                try {
                    ...
                    Log.e("DevilianActions:", "No activity to handle assist long press action.", e);
                }
                return;
                ...
                try {
                    ...
                    Log.e("DevilianActions:", "URISyntaxException: [" + action + "]");
                    return;
                }
                startActivity(context, intent);
                return;
